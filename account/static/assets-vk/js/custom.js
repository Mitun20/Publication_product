jQuery(function ($) {
    ...
    // Leftside JS
    $(".accordion-title-ls").click(function(e){
        var accordionitem = $(this).attr("data-tab");
        $("#"+accordionitem).slideToggle().parent().siblings().find(".accordion-content-ls").slideUp();

        $(this).toggleClass("active-title-ls");
        $("#"+accordionitem).parent().siblings().find(".accordion-title-ls").removeClass("active-title-ls");
    });
